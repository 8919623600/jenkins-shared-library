def call() {
    ...
    stage('Login to ECR')
    
     {
        ...
        sh "aws ecr get-login-password --region us-east-1 | docker login --username AWS -p "$(aws ecr get-login-password --region us-east-1)".dkr.ecr.us-east-1.amazonaws.com"
